...
ActiveRecord::Schema.define(:version => 20121108060404) do

  create_table "paperclip_atompub_attachments", :force => true do |t|
  ...
  add_index "paperclip_atompub_attachments", ["instance_type", "instance_id", "attachment_name", "style"], :name => "instance_type_and_instance_id_and_attachment_name_and_style", :unique => true
